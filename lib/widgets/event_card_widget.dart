...
class EventCardWidget extends StatelessWidget {
  ...
  String _getTimeAgoOrCountdown(DateTime eventTime) {
    ...
    if (diff.isNegative) {
      ...
      if (passed.inMinutes < 60) {
        return 'Akt. ${passed.inMinutes}m';
      } else if (passed.inHours < 24) {
        return 'Akt. ${passed.inHours}j';
      } else {
        return 'Selesai';
      }
    } else {
      if (diff.inMinutes < 60) {
        return 'dlm ${diff.inMinutes}m';
      } else if (diff.inHours < 24) {
        return 'dlm ${diff.inHours}j';
      } else {
  ...
  Widget build(BuildContext context) {
    ...
    // Micro-interaction with haptic feedback
    return Material(
          ...
          child: ClipRect(
            child: BackdropFilter(
              filter: ImageFilter.blur(
                sigmaX: hasCustomBg ? 6.0 : 0.0,
                sigmaY: hasCustomBg ? 6.0 : 0.0,
              ),
              child: Padding(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                _getTimeAgoOrCountdown(event.date),
  ...
  Widget _buildMetric({
    ...
    return Row(
      ...
      children: [
        Text(
          label,
          style: GoogleFonts.inter(fontSize: 10, color: const Color(0xFF888E9B), fontWeight: FontWeight.w500),
        ),
